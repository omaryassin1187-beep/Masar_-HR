...
<div style="background-color: #4A7C59; padding: 20px; border-radius: 8px 8px 0 0;">
    <h1 style="color: #ffffff; margin: 0; font-size: 24px;">Welcome to MasarHR!</h1>
    <p style="color: #e0f0e0; margin: 5px 0 0 0; font-size: 14px;">Your Account Has Been Created</p>
</div>
