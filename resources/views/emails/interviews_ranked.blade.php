...
<div style="background-color: #4A7C59; padding: 20px; border-radius: 8px 8px 0 0;">
    <h1 style="color: #ffffff; margin: 0;">Rankings Ready</h1>
...
<div style="background-color: #ffffff; padding: 25px; border: 1px solid #e2e8f0; border-radius: 0 0 8px 8px;">
    ...
    <p style="color: #334155;">The manager <strong>{{ $managerName }}</strong> has completed evaluating and ranking candidates for: <strong>{{ $jobTitle }}</strong></p>
    <p style="color: #334155;">You can now review the list and begin sending job offers.</p>
