...
<div style="background-color: #dc2626; padding: 20px; border-radius: 8px 8px 0 0;">
    <h1 style="color: #ffffff; margin: 0;">No Candidates Remaining</h1>
...
<div style="background-color: #ffffff; padding: 25px; border: 1px solid #e2e8f0; border-radius: 0 0 8px 8px;">
    ...
    <p style="color: #334155;">The last offer for <strong>{{ $jobTitle }}</strong> has been declined.</p>
    <p style="color: #334155;">There are no more qualified candidates in the ranking list.</p>
    <p style="color: #334155;">Please consider reopening the job posting or consulting the department manager.</p>
