...
<div style="background-color: #dc2626; padding: 20px; border-radius: 8px 8px 0 0;">
    <h1 style="color: #ffffff; margin: 0;">Contract Renewal Rejected</h1>
...
<div style="background-color: #ffffff; padding: 25px; border: 1px solid #e2e8f0; border-radius: 0 0 8px 8px;">
    ...
    <p style="color: #334155;"><strong>{{ $employeeName }}</strong> has rejected the contract renewal.</p>
    <p style="color: #334155;">The current contract will expire on <strong>{{ $endDate }}</strong>.</p>
    <p style="color: #334155;">Please begin offboarding procedures before the expiration date.</p>
