...
<div style="background-color: #4A7C59; padding: 20px; border-radius: 8px 8px 0 0;">
    <h1 style="color: #ffffff; margin: 0;">Auto Offer Sent</h1>
...
<div style="background-color: #ffffff; padding: 25px; border: 1px solid #e2e8f0; border-radius: 0 0 8px 8px;">
    ...
    <p style="color: #334155;">After the previous offer was declined, an automatic offer has been sent to the next ranked candidate.</p>

    <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
        <tr>
            <td style="padding: 10px; border: 1px solid #e2e8f0; background-color: #f1f5f9; font-weight: bold; width: 150px;">Candidate</td>
            <td style="padding: 10px; border: 1px solid #e2e8f0;">{{ $candidateName }}</td>
        </tr>
        <tr>
            <td style="padding: 10px; border: 1px solid #e2e8f0; background-color: #f1f5f9; font-weight: bold;">Position</td>
