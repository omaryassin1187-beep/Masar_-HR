...
class OverTimePendingApprovalNotification extends Notification implements ShouldBroadcastNow
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => "A mandatory overtime request has been submitted for {$this->overTime->user->full_name} and is awaiting your approval.",
        ];
    }
