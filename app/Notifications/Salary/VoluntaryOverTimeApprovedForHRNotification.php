...
class VoluntaryOverTimeApprovedForHRNotification extends Notification implements ShouldBroadcastNow
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => "A voluntary overtime request has been approved by {$this->overTime->approvedBy?->full_name}.",
        ];
    }
