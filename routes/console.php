...
use App\Console\Commands\ProcessTerminatedEmployees;
...
Schedule::command('app:create-monthly-payroll')->everyMinute();//monthlyOn(1, '00:05');
Schedule::command(ProcessTerminatedEmployees::class)->everyMinute();//->dailyAt('00:50');
